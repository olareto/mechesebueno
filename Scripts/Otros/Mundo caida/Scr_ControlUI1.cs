...
public class Scr_ControlUI1 : MonoBehaviour {
    ...
    void Update() {
        ...
        {
            vidas = personaje.GetComponent<Scr_Personaje_Colisiones1>().Vidas;
            meta = personaje.GetComponent<Scr_Personaje_Movimiento1>().Meta;
            monedas = personaje.GetComponent<Scr_Personaje_Colisiones1>().Monedas;
        } else
        {
            vidas = personaje.GetComponent<Scr_Personaje_Colisiones1>().Vidas;
            meta = personaje.GetComponent<Scr_Personaje_Movimiento1>().Meta;
